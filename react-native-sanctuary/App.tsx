...
import { StyleSheet, View, SafeAreaView, StatusBar, ScrollView, TouchableOpacity } from 'react-native';
...
const INITIAL_TASKS: Task[] = [
  { id: '1', title: 'Review quarterly metrics', description: 'Analyze user engagement data for the last 3 months.', time: '09:00 AM', category: 'Strategy', completed: false, priority: true },
  { id: '2', title: 'Walk in the garden', description: 'Essential cognitive reset. No devices allowed.', time: '04:30 PM', category: 'Wellness', completed: false },
  { id: '3', title: 'Order design prints', description: 'Get high-fidelity editorial layouts printed.', time: '10:00 AM', category: 'Creative', completed: false },
