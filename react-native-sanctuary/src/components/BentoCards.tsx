...
export function FocusCard() {
  return (
    <View style={styles.focusCard}>
      ...
      <Text style={styles.cardBody}>Your creative peak usually hits around 10 AM. Ready for it?</Text>
...
export function ConsistencyCard() {
  ...
  return (
    <LinearGradient colors={[theme.colors.primary, theme.colors.primaryContainer]} style={styles.consistencyCard}>
      ...
      <Text style={styles.cardBodyWhite}>You're on a 5-day streak. Keep the momentum!</Text>
